    ...
    <div class="wrapper">
        ...
        <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
            ...
            <nav class="vertnav navbar navbar-light">
                ...
                <ul class="navbar-nav flex-fill w-100 mb-2">
                    <li class="nav-item w-100">
                        ...
                        <ul class="collapse list-unstyled pl-4 w-100" id="stock">
                            <li class="nav-item">
                                <a class="nav-link pl-3" href="../../modules/clientes/clientes.php">
                ...
                <ul class="navbar-nav flex-fill w-100 mb-2">
                    <li class="nav-item dropdown">
                        <a href="../../modules/responsables/responsables.php" class="nav-link">
                            <i class="mdi mdi-account-tie"></i>
                            <span class="ml-3 item-text">RESPONSABLES</span>
                        </a>
                    </li>
                </ul>
                <ul class="navbar-nav flex-fill w-100 mb-2">
                    <li class="nav-item dropdown">
                        <a href="../../modules/report/" class="nav-link">
                            <i class="mdi mdi-view-list"></i>
                            <span class="ml-3 item-text">REPORTE</span>
                        </a>
                    </li>
                </ul>
            </nav>
