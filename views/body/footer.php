...
<script src="../../public/js/datamaps-zoomto.js"></script>
<script src="../../public/js/datamaps.custom.js"></script>
...
<script src='../../public/js/jquery.timepicker.js'></script>
<script src='../../public/js/dropzone.min.js'></script>
<script src='../../public/js/uppy.min.js'></script>
<script src='../../public/js/quill.min.js'></script>

<script src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.17.0/xlsx.full.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.17.0/dist/jszip.js"></script>
<script src="https://cdn.jsdelivr.net/npm/jszip-utils/dist/jszip-utils.js"></script>
<script src="https://cdn.jsdelivr.net/npm/js-xlsx/dist/jszip.js"></script>
<script src="https://cdn.jsdelivr.net/npm/js-xlsx-style/dist/xlsx.full.min.js"></script>

<div id="idusuario" data-valor="<?= $idusuario ?>"></div>
...
<script>
    ...
    dateDisplay.innerHTML = fechaFormateada;


    function refreshTime() {
        var dateString = new Date().toLocaleString("es-AR", {
